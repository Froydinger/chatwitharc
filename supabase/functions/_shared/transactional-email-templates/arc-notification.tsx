...
const h1 = { color: '#fafafa', WebkitTextFillColor: '#fafafa', fontSize: '22px', fontWeight: '700' as const, textAlign: 'center' as const, margin: '0 0 16px' }
const paragraph = { color: '#a1a1aa', WebkitTextFillColor: '#a1a1aa', fontSize: '15px', lineHeight: '26px', textAlign: 'center' as const, margin: '0 0 24px', whiteSpace: 'pre-wrap' as const }
