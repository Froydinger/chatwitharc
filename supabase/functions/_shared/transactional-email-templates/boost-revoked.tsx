...
const eyebrow = { color: '#fb7185', WebkitTextFillColor: '#fb7185', fontSize: '13px', fontWeight: '700' as const, letterSpacing: '0.08em', textTransform: 'uppercase' as const, textAlign: 'center' as const, margin: '0 0 12px' }
...
const button = { backgroundColor: '#e11d48', backgroundImage: 'linear-gradient(#e11d48, #e11d48)', borderRadius: '10px', color: '#ffffff', WebkitTextFillColor: '#ffffff', fontSize: '16px', fontWeight: '600' as const, textDecoration: 'none', textAlign: 'center' as const, display: 'inline-block', padding: '14px 36px', boxShadow: '0 4px 12px rgba(225, 29, 72, 0.25)' }
const small = { color: '#71717a', WebkitTextFillColor: '#71717a', fontSize: '13px', lineHeight: '22px', textAlign: 'center' as const, margin: '8px 0 12px' }
const secondaryCtaWrap = { textAlign: 'center' as const, margin: '0' }
const secondaryButton = { backgroundColor: '#27272a', backgroundImage: 'linear-gradient(#27272a, #27272a)', borderRadius: '10px', color: '#fafafa', WebkitTextFillColor: '#fafafa', fontSize: '14px', fontWeight: '600' as const, textDecoration: 'none', textAlign: 'center' as const, display: 'inline-block', padding: '12px 24px' }
