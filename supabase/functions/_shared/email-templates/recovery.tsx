      ...
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={paragraph}>
            We received a request to reset your ArcAI password. Click below to choose a new one.
          </Text>
...
const noticeText = { color: '#a1a1aa', WebkitTextFillColor: '#a1a1aa', fontSize: '13px', lineHeight: '20px', margin: '0' }
