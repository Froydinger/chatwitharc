...
const link = { color: '#0080f0', WebkitTextFillColor: '#0080f0', textDecoration: 'underline' }
...
const noticeText = { color: '#ef4444', WebkitTextFillColor: '#ef4444', fontSize: '13px', lineHeight: '20px', margin: '0' }
