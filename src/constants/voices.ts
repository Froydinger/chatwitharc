...
export const VOICES: VoiceOption[] = [
  ...
  { id: 'ripple', name: 'Riley', description: 'Australian English, masculine', noPreview: true },
  { id: 'quartz', name: 'Qira', description: 'Australian English, feminine', noPreview: true },
