...
const accentColorConfigs = {
  ...
  blue: {
    primary: "185 100% 60%",
    primaryGlow: "185 100% 70%",
    aiMessageBg: "185 15% 16%",
    aiMessageBorder: "185 20% 24%",
    lightAiMessageBg: "185 20% 97%",
    lightAiMessageBorder: "185 15% 92%",
    lightPrimary: "185 100% 55%",
    lightPrimaryGlow: "185 100% 65%",
  },
  green: {
    primary: "142 76% 42%",
