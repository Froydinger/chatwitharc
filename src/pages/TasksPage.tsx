...
export function TasksPage() {
  ...
  return (
    <div className="relative z-10 min-h-screen w-full text-foreground" style={{ paddingTop: "calc(env(safe-area-inset-top) + var(--arcai-desktop-titlebar-safe-area, 30px))" }}>
