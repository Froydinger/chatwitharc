    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
          ...
          <p>
            Free accounts get 3 voice sessions per UTC day, up to 10 minutes each. Boost subscribers and administrators
            get unlimited voice sessions up to 2 hours each. A free session ends automatically at 10 minutes, and inactive sessions pause
