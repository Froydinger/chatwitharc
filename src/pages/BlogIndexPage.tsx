  ...
  return (
    <div className="min-h-screen w-full bg-[hsl(0_0%_3.5%)] text-white selection:bg-primary/30 selection:text-primary-glow">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore tutorials, side-by-side model comparisons, and deep dives into ArcAI, free AI with natural voice, code canvas, image generation, and living memory."
        />
                  ...
                  <div className="relative w-full max-w-sm rounded-2xl border border-white/10 bg-black/40 p-6 backdrop-blur-xl shadow-2xl space-y-3">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex items-center justify-between rounded-lg bg-white/5 p-2 text-white/80">
                        <span>Natural Voice Mode (Voxi)</span>
        ...
        <section className="mt-20 relative overflow-hidden rounded-3xl border border-white/12 bg-gradient-to-r from-primary/20 via-neon-600/15 to-blue-600/15 p-8 sm:p-12 text-center backdrop-blur-2xl">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-white/70 leading-relaxed">
            {isAuthenticated
              ...
              : "Unlimited fast chat, 3 voice sessions per UTC day up to 10 minutes each, code canvas, and living memory, right in your browser."}
          </p>
