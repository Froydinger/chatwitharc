export const FREE_PLAN_FEATURES = [
  ...
  "3 natural voice sessions per day, up to 5 minutes each (powered by Voxi)",
...
export const FREE_PLAN_SUMMARY = "Arc Matrix™ chat with Ava (unlimited), Maya (10/day), and River (3/day), Deep Search, 3 Arc Imagix creations, 3 daily voice sessions up to 5 minutes each, living memory, files, canvases, reminders, and shared chats.";
