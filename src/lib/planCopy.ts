...
export const FREE_PLAN_SUMMARY = "Arc Matrix™ chat with Ava (unlimited), Maya (10/day), and River (3/day), Deep Search, 3 Arc Imagix creations, 3 voice sessions per UTC day up to 10 minutes each, living memory, files, canvases, reminders, and shared chats.";
export const BOOST_PLAN_SUMMARY = "Unlimited Ava, Maya, and River reasoning, unlimited Deep Search and Ultra Deep Search, unlimited Arc Imagix generation & editing, unlimited voice sessions up to 2 hours each, and live web-app publishing.";
