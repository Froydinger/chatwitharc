      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md rounded-2xl border border-border/30 bg-background shadow-2xl overflow-hidden p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Upgrade to ArcAI Boost for $10/month to publish your code online at a custom arc link, get unlimited Fast reasoning chats, and generate up to 30 images a day.
          </p>
