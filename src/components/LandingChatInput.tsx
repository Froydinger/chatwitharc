      ...
      >
        ...
        <div className="flex-1 landing-textarea-container">
          <Textarea
            ...
            className="border-none !bg-transparent text-foreground placeholder:text-muted-foreground resize-none min-h-[20px] max-h-[144px] leading-6 py-0 pl-0 pr-4 focus:outline-none focus:ring-0 text-[16px]"
            rows={1}
          />
        </div>
