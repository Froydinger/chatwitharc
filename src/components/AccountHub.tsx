          ...
          <div className="space-y-4 pr-2">
            ...
            <div className="pt-4 border-t border-border/20">
              <div className="flex items-center justify-center gap-4 text-xs text-muted-foreground">
                <a href="https://winthenight.org/support" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="hover:text-primary transition-colors underline">Support</a>
                <span>•</span>
                <a href="https://winthenight.org" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="hover:text-primary transition-colors underline">Win The Night™ Foundation</a>
              </div>
              <p className="text-[10px] text-muted-foreground text-center mt-2">
                © 2026 Win The Night™ Foundation. All rights reserved.
              </p>
            </div>
          </div>
        </ScrollArea>
