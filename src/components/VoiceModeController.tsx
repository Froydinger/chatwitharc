  ...
  useEffect(() => {
    ...
    freeSessionTimeoutRef.current = setTimeout(() => {
      ...
      toast({
        ...
        description: 'Free voice sessions last up to 5 minutes. Your conversation was saved. Upgrade to Boost for unlimited live voice sessions up to 2 hours each.',
      });
