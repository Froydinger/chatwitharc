...
const FREE_VOICE_SESSION_DURATION_MS = 10 * 60 * 1000;
...
Let emotion come through in your voice. Sound amused when something is funny, curious when something is interesting, gentle when the user is vulnerable, excited when the moment is exciting, and serious when it matters. Match the user's energy without copying or exaggerating it. Do not describe the emotion you are performing; let tone and wording carry it.
  ...
  useEffect(() => {
    ...
    freeSessionTimeoutRef.current = setTimeout(() => {
      ...
      toast({
        ...
        description: 'Free voice sessions last up to 10 minutes. Your conversation was saved. Upgrade to Boost for unlimited live voice sessions up to 2 hours each.',
      });
