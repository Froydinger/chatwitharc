...
import { Crown, MessageCircle, Mic, Headphones, Sparkles, X, ArrowLeft } from "lucide-react";
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={showCheckout ? "w-full max-w-lg max-h-[90vh] overflow-y-auto" : "w-full max-w-md"}
          >
