  ...
  return (
    <div className={`relative z-10 text-foreground whitespace-pre-wrap break-words leading-relaxed ${className}`}>
      <ReactMarkdown
        ...
        components={{
          p: ({ node, ...props }) => <p className="text-base leading-relaxed mb-2 last:mb-0 text-foreground/90" {...props} />,
          ...
          ul: ({ node, ...props }) => <ul className="list-disc pl-5 mb-2 space-y-1 marker:text-primary/60" {...props} />,
          ol: ({ node, ...props }) => <ol className="list-decimal pl-5 mb-2 space-y-1 marker:text-primary/60" {...props} />,
          li: ({ node, ...props }) => (
          ...
          h2: ({ node, ...props }) => <h2 className="text-lg font-semibold mt-3 mb-1.5 text-foreground" {...props} />,
          ...
          blockquote: ({ node, ...props }) => (
            <blockquote className="border-l-2 border-primary/40 pl-3 py-0.5 my-2 bg-primary/5 rounded-r italic text-muted-foreground" {...props} />
          ),
          ...
          td: ({ node, ...props }) => <td className="px-3 py-2 text-foreground/90" {...props} />,
