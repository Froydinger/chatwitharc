    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md p-0 bg-transparent border-0 shadow-none" style={{
        ...
        <div className="relative">
          ...
          <button
            onClick={onClose}
            className="absolute -top-4 -right-4 z-50 p-2 rounded-full bg-background/80 backdrop-blur border border-border/40 hover:bg-background/90 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>

          <GlassCard variant="bubble" glow className="w-full p-8">
