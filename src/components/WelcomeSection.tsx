  ...
  const quickPrompts = [
    {
      ...
      prompt: "Search the web right now and tell me what's trending today. What's everyone talking about?",
    },
    {
      label: "📰 News Flash",
      prompt: "Search the web for today's top news stories. Give me a quick rundown of what I should know about.",
    },
    {
      label: "💭 Reflect",
    ...
    },
    {
      ...
      prompt:
        "Search the web for what experts are predicting about the future. What's coming next in tech and culture?",
    },
    {
      label: "🎬 Cult Classic",
    ...
    {
      label: "🎵 Synthwave Dreams",
      prompt: "Create a vaporwave album cover concept with neon colors, retro 80s/90s aesthetic, and surreal imagery.",
    },
    {
      label: "💰 Stock Check",
      prompt: "Search the web for current stock market and crypto info. What's trending right now?",
    },
    {
      label: "🏆 Weird Facts",
      prompt: "Tell me some genuinely wild historical facts about the 90s that most people don't know.",
    },
    {
      label: "🎪 Fever Dream",
      prompt:
