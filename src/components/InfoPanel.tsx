...
export function InfoPanel() {
  const features = [
    {
      icon: () => <img src="/lovable-uploads/favicon-32x32.png" alt="Arc AI" className="w-6 h-6" />,
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      ...
      >
        ...
        >
          <img src="/lovable-uploads/favicon-32x32.png" alt="ArcAI" className="h-16 w-16" />
        </motion.div>
        ...
        <GlassCard variant="bubble" className="p-6">
          <div className="text-center space-y-4">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["React", "TypeScript", "Framer Motion", "Tailwind CSS", "OpenAI API", "Zustand"].map((tech) => (
                <motion.div
                  key={tech}
