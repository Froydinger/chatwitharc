          ...
          <div
            ...
            className={[
              ...
              isUser ? [
                ...
                "overflow-visible",
                "user-message-bubble" // Styled via CSS for glowy glass effect
                          ...
                          <div key={idx} className="text-foreground whitespace-pre-wrap break-words leading-relaxed">
                            <ReactMarkdown 
                              ...
                              components={{
                                ...
                                h3: ({node, ...props}) => <h3 className="text-base font-semibold mt-2 mb-1.5 text-foreground" {...props} />,
                                blockquote: ({node, ...props}) => (
                                  <blockquote className="border-l-2 border-primary/50 pl-4 my-3 italic text-muted-foreground" {...props} />
                                ),
