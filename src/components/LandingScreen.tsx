...
import { Download, Sparkles, Image, Paperclip, Brain, ArrowRight, Zap, Code, Menu, Mail, Crown, Check, MessageCircle, Mic, Headphones, Heart, Search, Globe, Lock, Plus, Clock, Send } from "lucide-react";
...
function ResearchDemo() {
  ...
  return (
    <div className="glass-card rounded-2xl relative overflow-hidden max-w-md mx-auto">
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b border-white/5">
        ...
        <span className="text-xs font-semibold text-gray-300">Research</span>
...
export function LandingScreen() {
  ...
  const downloadUrl = "https://jxywhodnndagbsmnbnnw.supabase.co/storage/v1/object/public/download-files/ArcAi-3.0.3.dmg";
  ...
  return (
    <div
      className={cn(
        ...
        (isPWAMode || isElectronApp) && !isMobile && "pt-[30px]"
      )}
      style={{
