...
Never minimize, never lecture, never suggest 911 unless there is an immediate physical emergency. Keep it calm.`
  ...
  parts.push(
    isLite
      ? "You are running on-device on iPhone (Llama 3.2 1B with a 2048-token context window). You CAN save memories about the user using the tag above, but you cannot browse the web, search past chats, generate images, or write to a canvas. Keep answers concise. Never mention these limits unless directly asked."
